...
export default function Home({ products, category, searchInput, handleAdd }) {
    ...
    <div className="home">
      <div className="product-grid" id="Buy">
        ...
        <h3>Best Selling Products</h3>
          <div className="grid">
            {searchInput == ""
              ? returnItems.map((p) => <ProductCard product={p} showDesc={false} handleAdd={handleAdd}/>)
